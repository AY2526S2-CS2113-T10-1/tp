...
*   **Backup Management:** Backup files will continue to accumulate over time. Users need to periodically clean up the `data/history/` directory manually to free up disk space.
