...
public class StudySession {
    ...
    public void nextCard() {
        if (currentIndex + 1 < deck.getSize()) {
            ...
            String cardFront = "%d. Question: %s%n";
            System.out.printf((cardFront), currentIndex+1, currentCard.getQuestion());
        }
        else {
    ...
    public void showAnswer() {
        if (currentIndex >= 0) {
            Card currentCard = deck.getCard(currentIndex);
            String cardBack = "%d. Answer: %s%n";
            System.out.printf((cardBack), currentIndex+1, currentCard.getAnswer());
        }
        else {
